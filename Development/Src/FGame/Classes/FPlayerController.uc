 ...
 */
reliable server function ServerSpawnVehicle(int ChassisIndex, int WeaponIndex1, int WeaponIndex2)
{
	...
	if (VF != None)
		VF.BuildVehicle(Pawn, ChassisIndex, WeaponIndex1, WeaponIndex2);
}
